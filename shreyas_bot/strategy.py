...
def select_smart_filler(user_msg: str) -> str:
    ...
    # 1. Program Selection keywords (Excellent choice! Let me check the batch timings...)
    ...
    if any(k in msg for k in program_keywords):
        return "shreyas_bot/filler_1.raw"
        
    # 2. Age / Timing (Perfect! Let me check the schedules for this age group.)
    ...
    if has_digit or any(k in msg for k in age_keywords):
        return "shreyas_bot/filler_2.raw"
        
    # 3. WhatsApp / Consent (Alright, let me get those details ready for you.)
    consent_keywords = ["yes", "please", "send", "sure", "ok", "okay", "whatsapp", "fine", "yeah", "agree", "confirm"]
    if any(k in msg for k in consent_keywords):
        return "shreyas_bot/filler_3.raw"
        
    # 4. Question / Inquiry / General questions (Interesting question! Let me check...)
    ...
    if any(k in msg for k in question_keywords) or "?" in msg:
        return "shreyas_bot/filler_4.raw"
        
    # 5. Default/Fallback (Sure, please give me a moment to check.)
    return "shreyas_bot/filler_5.raw"
